...
${bold}${NODENAME} is no longer actively supported!${normal}
   ...
   * ${green}https://deb.nodesource.com/setup_8.x â€” Node.js v8 LTS \"Carbon\"${normal} (recommended)
   * ${green}https://deb.nodesource.com/setup_10.x â€” Node.js v10 Current${normal}
